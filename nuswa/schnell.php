			...
			<div class="col-md-9" style="padding: 0px;">
				<div class="fluid-schnell block-title-schnell col-md-12" style="background-color: #1C3B54; text-align: left;">
					<ul class="nav navbar-nav">
						<li class="active"><a data-ajax="false" rel="external" href="schnell.php"><b class="fa fa-home"></b> Beranda</a></li>
				...
				<div class="fluid-schnell schnell-contianer-content-main">
					...
					<div class="fluid-schnell container-schnell-profile">
						...
						<div class="fluid-schnell deskripsi">
							...
							<a data-ajax="false" rel="external" href="schnell-detailkiriman.php"><h5>Selengkapnya...</h5></a>
						</div><!-- /.deskripsi -->
						...
						<div class="fluid-schnell header">
							...
							<div class="col-md-2 col-xs-2 content-right" style="text-align: right">
								...
								<ul class="dropdown-menu" role="menu" style="left: auto; right: 0px;">
									...
									<li><a data-ajax="false" rel="external" href="#"><b class="fa fa-trash-o"></b> Hapus Kiriman</a></li>
									<li class="divider"></li>
									<li><a data-ajax="false" rel="external" href="#"><b class="fa fa-thumb-tack"></b> Sematkan Kiriman</a></li>
								</ul>
							</div><!-- /action -->
						</div><!-- /.header -->
						<div class="fluid-schnell deskripsi">
					...
					<div class="fluid-schnell container-schnell-profile hidden-schnell">
						<div class="fluid-schnell header">
							<div class="col-md-1 col-xs-2 content-left">
								<img src="image/user/004.jpg" class="img-responsive">
							</div><!-- /Foto user -->
							<div class="col-md-9 col-xs-8">
								<a data-ajax="false" rel="external" href="#" class="title">Tersembunyi - OnyetCorp Corporate</a>
								<p class="deskripsi">
									<a data-ajax="false" rel="external" href="#" class="label label-danger">Artikel</a>&nbsp;<span class="label label-default">12 juni 2015</span>
								</p>
							</div><!-- /Name User -->
							<div class="col-md-2 col-xs-2 content-right" style="text-align: right;">
								<a data-ajax="false" rel="external" href="#" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="margin-top:12px;"><span class="caret"></span></a>
								<ul class="dropdown-menu" role="menu" style="left: auto; right: 0px;">
									<li><a data-ajax="false" rel="external" href="#"><b class="fa fa-eye"></b> Tampilkan Kiriman</a></li>
									<li><a data-ajax="false" rel="external" href="#"><b class="fa fa-trash-o"></b> Hapus Kiriman</a></li>
								</ul>
							</div><!-- /action -->
						</div><!-- /.header -->
