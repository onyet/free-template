...
?>
	<div class="container nuswa-container" style="padding-top: 15px;" id="profile-biodata">
		<div class="col-md-12 nuswa-title-block-right nuswa-block-biru">
			<b class="nf-nuswa-img-n"></b> Galeri ALbum Foto
		</div>
		<div class="col-md-12 normal-pad-col-junk nuswa-bg-detailbrg">
			<div class="col-md-12" style="padding: 0px 15px;">
				<div class="col-md-9"><h3 style="color:#B3AE9A;">Album Foto</h3></div>
				<div class="col-md-3">
					<a href="#" style="text-decoration:underline;line-height: 1.42857; display: inline-block;padding: 6px 12px;margin-top: 17px; margin-bottom: 10px;">Tambah Foto Album</a> 
					<a href="#" class="btn btn-primary" style="margin-top: 17px; margin-bottom: 10px;float:right;">Buat Album</a>
				</div>
			</div>
			<?php
						...
						<div class="col-md-2 col-xs-6" id="'.$id.'">
							<div class="item">
								<div class="col-md-12 normal-pad-col-junk image">
									<a href="profile-foto-isi.php">
										<div class="linker"><b class="fa fa-link"></b></div>
								...
								<div class="col-md-12 normal-pad-col-junk text">
									...
									<p>
										...
										<span class="col-md-6 content-right"><b class="fa fa-circle"> '.($id+12).' Foto</b></span>
									</p>
								</div>
							</div>
						</div>
